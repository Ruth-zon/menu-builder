...
const filters = [
  ...
  },
  {
    ...
    name: "בשרי / חלבי",
    options: [
      { value: "meaty", label: "בשרי", checked: false },
      { value: "dairy", label: "חלבי", checked: false },
      { value: "parve", label: "פרווה", checked: true },
    ],
  },
  {
    id: "size",
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6">
            ...
            <div className="flex items-center">
              ...
              >
                <span className="sr-only">הצג בטבלה</span>
          ...
          <section aria-labelledby="products-heading" className="pt-24">
